...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    New_Payment: function New_Payment(purchase) {
      ...
      if (purchase.payment_status == "paid") {
        ...
        setTimeout(function () {
          // Complete the animation of the  progress bar.
          nprogress__WEBPACK_IMPORTED_MODULE_1___default.a.done();
          _this0.$bvModal.show("Add_Payment");
        }, 500);
      }
    },
    Number_Order_Payment: function Number_Order_Payment() {
      ...
      axios.get("payment/purchase/Number/Order").then(function (_ref5) {
        var data = _ref5.data;
        return _this1.facture.Ref = data;
      });
    },
    //------------------------------------------------ Edit Pyament -------------------------------\\
      ...
      this.$swal({
        ...
        if (result.value) {
          ...
          axios["delete"]("payment/purchase/" + id).then(function () {
            _this13.$swal(_this13.$t("Delete.Deleted"), _this13.$t("Delete.PaymentDeleted"), "success");
    ...
    Get_Payments: function Get_Payments(id) {
      ...
      axios.get("purchases/Payments/" + id).then(function (response) {
        _this14.factures = response.data.payments;
        _this14.purchase_due = response.data.due;
        setTimeout(function () {
          // Complete the animation of the  progress bar.
          nprogress__WEBPACK_IMPORTED_MODULE_1___default.a.done();
          _this14.$bvModal.show("Show_payment");
        }, 500);
      })["catch"](function () {
        // Complete the animation of the  progress bar.
        setTimeout(function () {
  ...
  created: function created() {
    ...
    Fire.$on("Delete_Purchase", function () {
      setTimeout(function () {
        _this15.Get_Purchases(_this15.serverParams.page);
        // Complete the animation of the  progress bar.
        nprogress__WEBPACK_IMPORTED_MODULE_1___default.a.done();
      }, 500);
    });
    ...
    Fire.$on("Update_Facture_purchase", function () {
      setTimeout(function () {
        _this15.Get_Payments(_this15.Purchase_id);
        _this15.Get_Purchases(_this15.serverParams.page);
        // Complete the animation of the  progress bar.
        nprogress__WEBPACK_IMPORTED_MODULE_1___default.a.done();
        _this15.$bvModal.hide("Add_Payment");
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_purchase_vue_vue_type_template_id_67d8d448__WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_purchase_vue_vue_type_template_id_67d8d448__WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
