...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    GET_Sales_Return: function GET_Sales_Return(page) {
      ...
      axios.get("returns/sale?page=" + page + "&Ref=" + this.Filter_Ref + "&date=" + this.Filter_date + "&client_id=" + this.Filter_Client + "&statut=" + this.Filter_status + "&warehouse_id=" + this.Filter_warehouse + "&payment_statut=" + this.Filter_Payment + "&SortField=" + this.serverParams.sort.field + "&SortType=" + this.serverParams.sort.type + "&search=" + this.search + "&limit=" + this.limit).then(function (response) {
        _this1.sales_return = response.data.sale_Return;
        _this1.customers = response.data.customers;
  ...
  created: function created() {
    ...
    Fire.$on("Update_payment_Return_sale", function () {
      setTimeout(function () {
        _this15.Get_Payments(_this15.sale_return_id);
        _this15.GET_Sales_Return(_this15.serverParams.page);
        // Complete the animation of the  progress bar.
        nprogress__WEBPACK_IMPORTED_MODULE_1___default.a.done();
        _this15.$bvModal.hide("Add_Payment");
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_sale_return_vue_vue_type_template_id_c82b36f2__WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_sale_return_vue_vue_type_template_id_c82b36f2__WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
